...
dataset = FOREACH joined GENERATE movies::movie_name as movie_name, avg_ratings::avg_rating as avg_rating, SUBSTRING(movies.movie_name, 1, (int)SIZE(movies.movie_name)) as name;
